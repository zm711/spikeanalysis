...
class AllDatasets(SpikeAnalysis, SpikeData, StimulusData):
    ...
    def __init__(self, filenames: list[str], spike_kwargs:dict, analog_kwargs:Optional[dict]=None, trial_group: Optional[dict]=None, stim_names : Optional[dict]=None):
        self.spike_analyis=[]
    ...
    def run_all(self, psth_window: Union[list, list[list]], psth_time_bin_ms, bsl_window: Union[list, list[list]], z_window:Union[list, list[list]], z_time_bin_ms,  lat_bsl_window: Union[list,list[list]], lat_time_bin_ms, correlation_time_bin_ms:float, dataset = 'z_scores', num_shuffle: int=300):
