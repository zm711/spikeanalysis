...
def test_kolmo_smir_stats_dist():
    ...
    k_vals = kolmo_smir_stats([dis1, dis2], type=None)
...
def test_kolmo_smir_stats_dist_complex():
    ...
    dis1 = np.array([[1,1,0.],[0,1,0,]])
    dis2 = np.array([[0,1.,0], [1,1,0.]])
    k_vals = kolmo_smir_stats([dis1, dis2], type=None)
...
def test_kolmo_smir_stats_isi():
    ...
    k_vals = kolmo_smir_stats(test_dict, type='isi')
...
def test_kolmo_stats_dist_diff():
    ...
    dis1 = np.array([0, 0, 0.])
    dis2 = np.array([10., 10, 10, 10, 10, 10, ])
...
def test_kolmo_dist_latency():
    ...
    k_vals = kolmo_smir_stats(test_dict, type='latency')
